...
def test_sabiork_reaction_618_notebook_exists_and_imports_package_code() -> None:
    ...
    assert "build_model_config_from_registry_case" in source
...
def test_sabiork_reaction_618_notebook_uses_local_fixtures_only() -> None:
    ...
    assert "\"data\" / \"kinetic_records\" / \"sabiork\"" in source
...
def test_sabiork_reaction_618_notebook_executes_through_modelability() -> None:
