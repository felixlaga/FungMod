...
| PR-05 | PRODUCT-001 build-first exploratory virtual-experiment expansion | current next; partial after environment-grid helper and assumption-summary outputs | Expand the researcher-facing simulator toward the central product: broader fungus/source + substrate + environment inputs, explicit exploratory priors, complete degradation curves, uncertainty bands, provenance, limitations, and missing-mechanism reports. |
