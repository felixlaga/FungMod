...
| PR-07 | BIO-003 mechanism expansion through generic process laws | selected/proposed for reversible product inhibition | Add more biology only as implemented, provenance-backed, maturity-labelled, tested process laws. Prefer reusable mechanism families over case-specific fungus branches. |
...
| BIO-003 generic mechanism expansion | selected/proposed for reversible product inhibition | `AGENTS.md`, `foundation_progress/BIO_READINESS_LITE.md`, `foundation_progress/BIO_003_GENERIC_PROCESS_LAWS.md`, `foundation_progress/proposals/BIO_003_REVERSIBLE_PRODUCT_INHIBITION.yml`, future mechanism tests | Biology may expand only through explicit mechanisms with provenance, maturity labels, tests, and honest limitations. The selected first target is generic reversible product inhibition; this selection does not yet integrate it into configured or registry-backed virtual experiments. No fungus-specific branches in generic modules. |
